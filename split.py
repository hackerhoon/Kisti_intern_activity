...
def main():
    ...
    #tmp = SetDataFrame()
    #dirpath = ['/mnt/d/ML_data/2017_1234','/mnt/d/ML_data/2018_1234']
    ...
    for i,dpath in enumerate(dirpath,start=1):
        ...
        for file in filelist:
            ...
            if not maliciousdata.empty:
                SaveData(maliciousdata,f'/mnt/c/Users/master/TASK/maldata/{savename}'+f'({2017+i}).csv')

            if not benigndata.empty:
                SaveData(benigndata,f'/mnt/c/Users/master/TASK/benigndata/{savename}'+f'({2017+i}).csv')
            del dask_data
            del data
            del maliciousdata
            del benigndata
