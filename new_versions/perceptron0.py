...
def LearningRFModel(filelist):
    ppn = Perceptron(eta0=0.1, random_state=0, n_jobs=-1)
...
if __name__ == '__main__':
    ...
    # model training
    clf, x_test, y_test = LearningRFModel(filelist)
    
    joblib.dump(clf, f"Models0\\integrated_perceptron_model.pkl")
    classifier = joblib.load(f"Models0\\integrated_perceptron_model.pkl")
    # model test
