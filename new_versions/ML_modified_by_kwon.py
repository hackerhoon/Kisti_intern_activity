...
def LearningRFModel(file):
    ...
    try:
        ...
        x_train, x_test, y_train, y_test = train_test_split(X, Y, test_size=0.1, shuffle=True, random_state=2022)
...
if __name__ == '__main__':
    ...
    for idx, file in enumerate(filelist):
        # model training
        rfc, x_test, y_test = LearningRFModel(file)

        joblib.dump(rfc, "model_{}.pkl".format(str(idx)))
        classifier = joblib.load("model_{}.pkl".format(str(idx)))
